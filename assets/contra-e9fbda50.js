import{B as u}from"./bufferShader-601b8424.js";import{S as T,P,W as R,V as w,g as m,M as X,a as I,j as L,C}from"./three.module-2e0eea6d.js";import{f as A,h as G,g as Y,y as U,o as h,c as D,a as p,_ as N}from"./index-4c8cf54e.js";const z=`// Gameplay\r
\r
// debug cheats\r
...
\r
    gl_FragColor = vec4( color, 1.0 );\r
}`,b=`// UI and some foreground stuff\r
\r
\r
uniform vec3      iResolution;           // viewport resolution (in pixels)\r
uniform float     iTime;                 // shader playback time (in seconds)\r
...
\r
    ...
    \r
    gl_FragColor = vec4( color, 1.0 );\r
}`,H=`uniform vec3      iResolution;           // viewport resolution (in pixels)\r
uniform sampler2D iChannel0;          // input channel. XX = 2D/Cube\r
...
{\r
    ...
    \r
    gl_FragColor = vec4( color, 1.0 );\r
}`,M={id:"shader"},O=A({__name:"contra",setup(k){let f=G(null);return Y(()=>{const o=document.getElementById("shader"),d=new T,x={width:o.offsetWidth,height:o.offsetHeight};window.addEventListener("resize",()=>{x.width=window.innerWidth,x.height=window.innerHeight,i.aspect=x.width/x.height,i.updateProjectionMatrix(),n.setSize(x.width,x.height),n.setPixelRatio(Math.min(window.devicePixelRatio,2))});const i=new P(75,x.width/x.height,.1,100);i.position.set(0,0,.587),d.add(i);const n=new R({antialias:!0});n.setSize(x.width,x.height),n.setPixelRatio(Math.min(window.devicePixelRatio,2)),o==null||o.appendChild(n.domElement);let l,c,a,y,s,t={Left:!1,Right:!1,Up:!1,Down:!1,Jump:!1,Shoot:!1};const E=e=>{switch(e.keyCode){case 37:t.Left=!0;break;case 39:t.Right=!0;break;case 38:t.Up=!0;break;case 40:t.Down=!0;break;case 32:t.Jump=!0;break;case 65:t.Shoot=!0;break}},g=e=>{switch(e.keyCode){case 37:t.Left=!1;break;case 39:t.Right=!1;break;case 38:t.Up=!1;break;case 40:t.Down=!1;break;case 32:t.Jump=!1;break;case 65:t.Shoot=!1;break}console.log(e)};window.addEventListener("keydown",E),window.addEventListener("keyup",g);{const{width:e,height:S}=n.getSize(new w),r=new m(e,S,n.pixelRatio);l=new u(n,i,z,{iTime:{value:0},iResolution:{value:r},iChannel0:{value:null},iFrame:{value:0},customLeft:{value:0},customUp:{value:0},customDown:{value:0},customRight:{value:0},customJump:{value:0},customShoot:{value:0}},r.x,r.y),c=new u(n,i,W,{iTime:{value:0},iResolution:{value:r},iChannel0:{value:null}},r.x,r.y),a=new u(n,i,V,{iTime:{value:0},iResolution:{value:r},iChannel0:{value:null},iChannel1:{value:null}},r.x,r.y),y=new u(n,i,b,{iTime:{value:0},iResolution:{value:r},iChannel0:{value:null},iChannel1:{value:null}},r.x,r.y),s=new u(n,i,H,{iResolution:{value:r},iChannel0:{value:null}},r.x,r.y);const _=new X(new I(1.6,.9),new L({map:s.readBuffer.texture}));d.add(_)}const v=new C,B=()=>{if(s){const e=v.getDelta();s.uniforms.iChannel0.value=y.readBuffer.texture,s.render();for(let S in t)l.uniforms["custom"+S].value=t[S]?2:0;l.uniforms.iTime.value+=e,l.uniforms.iChannel0.value=l.readBuffer.texture,l.uniforms.iFrame.value++,l.render(),c.uniforms.iTime.value+=e,c.uniforms.iChannel0.value=l.readBuffer.texture,c.render(),a.uniforms.iTime.value+=e,a.uniforms.iChannel0.value=l.readBuffer.texture,a.uniforms.iChannel1.value=c.readBuffer.texture,a.render(),y.uniforms.iTime.value+=e,y.uniforms.iChannel0.value=l.readBuffer.texture,y.uniforms.iChannel1.value=a.readBuffer.texture,y.render()}n.render(d,i),f.value=window.requestAnimationFrame(B)};B()}),U(()=>{console.log(11111111111),cancelAnimationFrame(f.value)}),(o,d)=>(h(),D("div",M,d[0]||(d[0]=[p("div",{class:"info"},[p("div",null,"射击：A"),p("div",null,"跳跃：space"),p("div",null,"移动：方向键")],-1)])))}});const j=N(O,[["__scopeId","data-v-0d38164f"]]);export{j as default};
