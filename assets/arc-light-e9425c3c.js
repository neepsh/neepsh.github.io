import{O as W,B as j,F as L,M as F,b as g,U as Q,V as o,c as h,C as N,d as x,e as H,D,R as X,N as z,f as Z,g as U,A as Y,W as K,S as q,P as J,H as $,h as ee,G as te,i as ie,T as re,j as se,a as ae}from"./three.module-2e0eea6d.js";import{C as le}from"./ColladaLoader-b1e833ca.js";import{O as ne}from"./OrbitControls-5ebfa66f.js";import{f as oe,x as ue,h as P,g as he,y as fe,o as de,c as ce,_ as ge}from"./index-4c8cf54e.js";const V={uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor.a *= opacity;
				...
				}`})}getEdgeDetectionMaterial(){return new g({uniforms:{maskTexture:{value:null},texSize:{value:new o(.5,.5)},visibleEdgeColor:{value:new U(1,1,1)},hiddenEdgeColor:{value:new U(1,1,1)}},vertexShader:`varying vec2 vUv;
				...
				}`})}getSeperableBlurMaterial(e){return new g({defines:{MAX_RADIUS:e},uniforms:{colorTexture:{value:null},texSize:{value:new o(.5,.5)},direction:{value:new o(.5,.5)},kernelRadius:{value:1}},vertexShader:`varying vec2 vUv;
				...
				}`})}getOverlayMaterial(){return new g({uniforms:{maskTexture:{value:null},edgeTexture1:{value:null},edgeTexture2:{value:null},patternTexture:{value:null},edgeStrength:{value:1},edgeGlow:{value:1},usePatternTexture:{value:0}},vertexShader:`varying vec2 vUv;
